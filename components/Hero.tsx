...
export default function Hero() {
    return (
       <div className='pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48 antialiased'>
                   ...
                   <div className="mt-20">
                       <div>
                           <a href="#" className="inline-flex space-x-4">
                               <span className="rounded bg-rose-50 px-2.5 py-1 text-xs font-semibold text-rose-500 tracking-wide uppercase"> Whats new</span>
                       ...
                       <div className='mt-6'>
                           <div className='inline-flex items-center divide-x divide-gray-300'>
                               ...
                               <div className='min-w-0 flex-1 pl-5 py-1 text-sm text-gray-500 sm:py-3'>
                                   <span className='font-medium text-gray-900'> Rated 5 start </span> by over {' '}
                                   <span className='font-medium text-gray-900'> 500 beta users </span>
                               </div>
                           </div>
                       </div>
                   </div>
